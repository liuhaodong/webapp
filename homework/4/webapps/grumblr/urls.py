...
urlpatterns = patterns('',
    ...
    url(r'^homepage/add_post$','grumblr.views.add_post', name='add_post'),
    url(r'^homepage/delete_post/(?P<id>\d+)$', 'grumblr.views.delete_post', name='delete_post'),
    ...
    url(r'^homepage/add_comment$','grumblr.views.add_comment',name='add_comment'),
